process UCSC_CHAINSTITCHID {
    ...
    container "${ workflow.containerEngine in ['singularity', 'apptainer'] && !task.ext.singularity_pull_docker_container ?
        'https://depot.galaxyproject.org/singularity/ucsc-chainstitchid:482--h0b57e2e_0' :
        'quay.io/biocontainers/ucsc-chainstitchid:482--h0b57e2e_0' }"
